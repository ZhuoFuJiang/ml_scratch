...
from utils.data_manipulation import train_test_split, to_categorical, standardize, normalize
from supervised_learning.decision_tree import XGBoostRegressionTree
...
class XGBoost(object):
    ...
    def __init__(self, n_estimators=200, learning_rate=0.001, min_samples_split=2,
                 min_impurity=1e-7, max_depth=2, regression=False):
